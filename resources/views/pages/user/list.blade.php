                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        <td class=" td-checkbox">
                                            <label class="form-check-label">
                                            <input class="optioncheck form-check-input" name="optioncheck[]" value="<?php echo $data['id_user'] ?>" type="checkbox" />
                                            </label>
                                        </td>
                                        <!--PageComponentStart-->
                                        <td class="td-id_user">
                                            <a href="<?php print_link("/user/view/$data[id_user]") ?>"><?php echo $data['id_user']; ?></a>
                                        </td>
                                        <td class="td-user">
                                            <?php echo  $data['user'] ; ?>
                                        </td>
