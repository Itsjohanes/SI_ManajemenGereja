                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-user-holder" class=" ">
                                            <textarea placeholder="Enter User" id="ctrl-user" data-field="user"  data-url="componentsdata/user_user_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" required="" rows="5" name="user" class=" form-control"><?php  echo $data['user']; ?></textarea>
